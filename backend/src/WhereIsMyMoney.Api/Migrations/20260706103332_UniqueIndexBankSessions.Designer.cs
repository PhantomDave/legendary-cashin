...
namespace WhereIsMyMoney.Api.Migrations
{
    ...
    [Migration("20260706103332_UniqueIndexBankSessions")]
    partial class UniqueIndexBankSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhereIsMyMoney.Api.Models.EnableBankingModels.EnableBanking", b =>
                {
                    ...
                    b.Property<string>("EnableBankingType")
                        .IsRequired()
                        .HasMaxLength(13)
            ...
            modelBuilder.Entity("WhereIsMyMoney.Api.Models.EnableBankingModels.EnableBankingBankSession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AccountId", "IntegrationId", "AspspName", "AspspCountry")
                        .IsUnique()
                        .HasDatabaseName("IX_EnableBankingSessions_AccountId_IntegrationId_AspspName_AspspCountry");

                    b.ToTable("EnableBankingSessions");
                });

            modelBuilder.Entity("WhereIsMyMoney.Api.Models.RuleModels.Rule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.PrimitiveCollection<int[]>("CategoryIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.HasIndex("AccountId", "IsActive", "Priority")
            ...
            modelBuilder.Entity("WhereIsMyMoney.Api.Models.EnableBankingModels.EnableBankingIntegration", b =>
                {
                    b.HasBaseType("WhereIsMyMoney.Api.Models.EnableBankingModels.EnableBanking");
